"""Tests for the PD controller on MuJoCo with the RRR arm.

Mirrors test_pd.py.  Replaces DrakeSimulator with MuJoCoSimulator;
everything else — tolerances, targets, step counts — is identical.

Usage:
    pytest tests/test_pd_mujoco.py -v
"""
